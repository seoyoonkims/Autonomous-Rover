...
class MotionPlanner
{
  public:
    ...
    void Receive(const std_msgs::Bool& msg);
    ...
    // - collision checking
    double mindist_colli = 9999999; // the minimum distance to obstacle to collide with // modify
    double INFLATION_SIZE = 0.1 / mapResol; // [grid] inflation size [m] / grid_res [m/grid]
